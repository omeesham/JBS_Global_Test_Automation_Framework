...
3. Appends entry to the bug-blocked tests registry:
...
The bug report index files are fully regenerated by scanning all bug metadata on every report create/update. Never appended.
