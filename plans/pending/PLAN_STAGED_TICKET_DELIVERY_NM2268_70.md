...
| L-2 | `WALK_SORT_ORACLES` in `src/data/corporate-pricing/override.ts` is commented `(NM-2270)` and used only by TC-046/047/049 | Remove from branches that don't carry those tests (confirm against `.claude/state/ua-worker/dlv-r3b/depgraph.md`) |
