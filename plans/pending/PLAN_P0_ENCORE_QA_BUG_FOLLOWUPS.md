...
- **What we know**: Same broken-cascade pattern as LI-002 — 3 of 11 LI parent-children groups affected (LDW, C&C, Service Charge). Cascade probe across all 11 groups documented in `li-cascade-probe-2026-04-28.json`.
