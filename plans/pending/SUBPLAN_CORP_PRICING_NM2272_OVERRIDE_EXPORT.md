...
| BUILDER | corporate-pricing-override.spec.ts + page object extensions | `clients/encore/tests/corporate-pricing/corporate-pricing-override.spec.ts` (all Phase 1–6 TCs) | `npx playwright test --list` resolves new TC IDs; spec run green ×2 |
