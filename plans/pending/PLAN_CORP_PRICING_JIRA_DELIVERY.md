...
- [ ] `SUBPLAN_CORP_PRICING_NM2263_NEW_PRICEBOOKS.md` — new pricebooks Eq+Labor + update (Depends: none)
- [ ] `SUBPLAN_CORP_PRICING_NM2267_OVERRIDE.md` — override nav + full override coverage (Depends: none)
- [ ] `SUBPLAN_CORP_PRICING_NM2262_LOC_EXPORT.md` — loc export real download + verify (Depends: none; builds download infra)
- [ ] `SUBPLAN_CORP_PRICING_NM2264_EXPORT_ALL.md` — Export ▾ 4 variants, drift-fix + real download (Depends: NM2262)
- [ ] `SUBPLAN_CORP_PRICING_NM2305_LOC_IMPORT.md` — loc import real upload + validation (Depends: none; builds upload infra)
