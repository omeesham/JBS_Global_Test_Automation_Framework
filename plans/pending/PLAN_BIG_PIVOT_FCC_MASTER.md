...
- [x] Location Products (distinct surface): **QUICK tier DONE 2026-09-01** — `PLAN_NM2253_ITEM_SEARCH_COVERAGE_QUICK.md` closed (41 TCs ISR PRS21/PCD10/PGR10, module run-all 42 passed; BUG-ISR-PCD-001 + BUG-ISR-PRS-001 filed; 42 elements seeded into `SUBPLAN_PRODUCTS_DQU.md`; fresh-session audit pending in `PLAN_NM2253_ITEM_SEARCH_EXTERNAL_01_AUDIT.md`). Remaining checkbox scope = the DQU DEEP tier (`SUBPLAN_PRODUCTS_00_FOUNDATION` + `_FCC` stayed SUPERSEDED, never executed).
