...
| GIVER | per-TC status in the deliverable + the QA tracker | `clients/encore/testcases/encore_test_cases.xlsx`<br>`clients/encore/testcases/encore-qa-tracker.xlsx` | `npm run check:tc-parity` exit 0 |
