...
- `clients/encore/specs_planning/test-cases/setup/local-office/local_office_settings_test_cases.md` (sample artifact to benchmark)
- `clients/encore/exports/local_office_settings_test_cases.csv` (sample CSV)
