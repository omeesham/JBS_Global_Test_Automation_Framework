...
5. Re-export CSV: `npx ts-node export_test_cases/to-csv.ts clients/encore/specs_planning/test-cases/setup/locations/locations_account_address_test_cases.md clients/encore/test_cases_csv/locations_account_address_test_cases.csv`. Verify Tags column.
