# SUBPLAN_CORP_PRICING_1443_DETAIL_FCC_P2 — Pricing Detail FCC field-coverage (Wave-2 STUB)  [SUPERSEDED]

> **SUPERSEDED (2026-06-24) by [PLAN_CORP_PRICING_JIRA_DELIVERY.md](PLAN_CORP_PRICING_JIRA_DELIVERY.md).** No work lost — folded item-for-item (full depth) into [SUBPLAN_CORP_PRICING_NM2260_FILTERS_DETAIL.md](SUBPLAN_CORP_PRICING_NM2260_FILTERS_DETAIL.md): New Price + Max Discount numeric BVA, non-numeric NaN guard, currency-format validation, empty→Base-Price fallback, read-only Price, content-anchored reads, CPR-DETAIL-BUG-A, NM-1874/2094/2095/1967. Conservation restructure (LR-050). Retained for history only; do NOT execute.
