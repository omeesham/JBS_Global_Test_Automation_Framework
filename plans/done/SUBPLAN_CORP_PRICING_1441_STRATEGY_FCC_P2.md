# SUBPLAN_CORP_PRICING_1441_STRATEGY_FCC_P2 — Strategy FCC field-coverage (Wave-2 STUB)  [SUPERSEDED]

> **SUPERSEDED (2026-06-24) by [PLAN_CORP_PRICING_JIRA_DELIVERY.md](PLAN_CORP_PRICING_JIRA_DELIVERY.md).** No work lost — folded item-for-item (full depth) into [SUBPLAN_CORP_PRICING_NM2261_STRATEGY.md](SUBPLAN_CORP_PRICING_NM2261_STRATEGY.md): FormArray multi-row add/edit/remove/delete-all, save-cycle revert, each strategy-type option, duplicate-name, NM-2047 mutual-exclusion, NM-2059 duplicate-names. Conservation restructure (LR-050). Retained for history only; do NOT execute.
