 ...
 * USED-BY: tests/specs/locations/location-local-information.spec.ts
 * RULES: Values must match live DOM for office 1604. Update when defaults change.
 */

import { SetupSelectors } from '../../src/selectors';

type SelectorKey = keyof typeof SetupSelectors;
...
/** Verified label text extracted from dt:has-text("...") in src/selectors/setup/local-info.ts */
