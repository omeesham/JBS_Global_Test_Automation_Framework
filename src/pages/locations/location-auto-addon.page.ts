...
import { SetupAutoAddonSelectors } from '../../selectors/locations/auto-addon';
...
export class LocationAutoAddonPage extends BasePage {
  ...
  /** Save button locator — uses partition import to avoid btnSave collision with LocalOfficeSettingsSelectors. */
  private get saveButton(): Locator {
    return this.page.locator(SetupAutoAddonSelectors.btnSave);
  }
