 ...
 * DEPENDS-ON: BasePage, SetupSelectors, DynamicSelectors, logger.ts, framework-contracts/index.ts
 * USED-BY: tests/specs/locations/location-pricing.spec.ts, fixtures.ts
