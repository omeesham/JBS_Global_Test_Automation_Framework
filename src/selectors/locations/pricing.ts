...
export const SetupPricingSelectors = {
  ...
  chkPriceGuideInclusive: 'div.flex:has(> span:text-is("Price Guide Inclusive")) button[role="checkbox"]',
  ...
  drpPrimaryProductionEquipmentPricing: 'div:has(> span:text-is("Primary Production Equipment Pricing")) button[role="combobox"]',
