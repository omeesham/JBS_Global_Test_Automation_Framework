...
const ROLES = [
  ...
  { value: 'data_engineer', label: 'Data Engineer', desc: 'Data & AI validation' },
];
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <img src="/jbs-logo.svg" alt="JBS IntelliQE" className="h-44" />
          </div>
        </div>
        <div /><div />
      </div>
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="bg-[#1E1B4B] rounded-2xl p-4 inline-block">
              <img src="/jbs-logo.svg" alt="JBS IntelliQE" className="h-28" />
            </div>
            <p className="text-[9px] font-semibold tracking-[0.15em] text-[#7C3AED] uppercase mt-2">IntelliQE</p>
          </div>
          ...
          <div className="text-center mt-6">
            <p className="text-xs text-gray-400">&copy; IntelliQE</p>
          </div>
        </div>
      </div>
    </div>
