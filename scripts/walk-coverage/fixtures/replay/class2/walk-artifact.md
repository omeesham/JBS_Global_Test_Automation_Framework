# Field Inventory — Corporate Pricing › Product Group Override (Class 2 Replay Fixture)
...
**CrossCheck**: clean
**Completion_Record**: scripts/walk-coverage/fixtures/replay/class2/completion-record.json
