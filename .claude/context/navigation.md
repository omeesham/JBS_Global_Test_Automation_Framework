...
| Get authenticated test session | `clients/${ACTIVE_CLIENT}/config/environments/.env.local` (creds; CI uses `.env.e2e` + Secrets) + `authenticatedSession` fixture in `clients/${ACTIVE_CLIENT}/src/infra/fixtures.ts` | LR-ENC-003 |
