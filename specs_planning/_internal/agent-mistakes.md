...
| GEN-028 | NEVER declare completion without running tests. Typecheck and --list are NOT test runs. Phase 3 (First Run) is MANDATORY — execute `npx playwright test <spec> --project=chrome --headed`, report pass/fail count, fix failures in Phase 4. Only after all tests pass can you mark TCs as Automated | Shared Setup Locations: generator created 4 files, marked 17 TCs Automated, said "Done" — never ran a single test |
