...
test.describe.serial('Local Office Settings — Basic Information @locations @local-office-settings', () => {
 ...
 // Baseline enforcement — reset date offsets if dirty from prior failed run.
    let dirty = false;
 ...
 // Baseline enforcement — reset Default Order Type if dirty from prior crashed BAS-022.
