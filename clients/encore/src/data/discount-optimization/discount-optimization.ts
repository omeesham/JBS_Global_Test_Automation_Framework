 ...
 * "InterContinental Chicago" (ID 1121) is a stable row with an existing No Implied Start
...
/** Expected substring in the matched row name. */
export const DOP_CASE_INSENSITIVE_MATCH = 'Abbey';
...
/** Valid date for No Implied Start field (MM/DD/YYYY). */
