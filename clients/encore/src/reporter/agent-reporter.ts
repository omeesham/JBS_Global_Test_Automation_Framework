 ...
 *  Full type lives in framework-internal `src/framework-contracts/diagnostics` (not duplicated client-side). */
...
interface FailureSummary {
 ...
 /** Per-layer per-attempt retry telemetry. Added during an earlier framework hardening pass. */
 ...
 * Priority-ordered pattern matching per the RCA protocol.
 */
