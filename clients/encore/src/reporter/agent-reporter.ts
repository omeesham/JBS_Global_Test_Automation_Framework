...
/** Triage placeholder — populated post-triage, always null at reporter time.
...
export interface FailureEntry {
 ...
 /** Triage result (populated post-triage, null initially). */
  triage: TriageResult | null;
 /** Bug report ID if triage = BUG (e.g., ""). */
  bugReportId: string | null;
 /** Detailed bug hunt category from classifier (populated post-triage, null initially). */
  bugHuntCategory: string | null;
 /** Test-ID status: PRESENT/MISSING/CHANGED (populated post-triage, null initially). */
  testIdStatus: string | null;
 /** Feature change magnitude: SMALL/BIG (populated post-triage, null initially). */
...
interface FailureSummary {
 ...
 /** Triage classification stats (populated after triage). */
  triageStats: { bugs: number; featureChanges: number; testDefects: number; uncertain: number } | null;
 /** Paths to bug report JSON files generated by the triage pipeline. */
