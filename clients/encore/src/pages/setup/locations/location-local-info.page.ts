 ...
 * USED-BY: tests/specs/setup/locations/location-local-information.spec.ts, fixtures.ts
 * RULES: Never use raw page.* in specs â€” all interactions go through this page object.
 *        All selectors come from src/selectors/index.ts (LocationSettingsSelectors).
