...
import {
  ...
  ROW_1_EXPECTED,
} from '../../src/data/testdata/locations/location-management-history.data';
import { OFFICE_NO } from '../../src/data/testdata/common.data';
import { NOTE_SEQUENTIAL_A, NOTE_SEQUENTIAL_B } from '../../src/data/testdata/locations/location-notes.data';
...
// specs/locations/history/location-hist-notes.spec.ts. This describe is the single source of Notes col-69 HIST truth.
//
