...
picker — without ever creating a group.
...
persistence of an executed search; the Status column render.

**Out of scope, with reasons**:

| Excluded | Reason |
|---|---|
| Creating a group (Save path, drag or double-click sub-class add) | Permanently mutates the shared catalog; belongs to the deeper, data-writing pass |
...
| Nothing may be persisted | Save is never clicked; Cancel discards every typed value |
