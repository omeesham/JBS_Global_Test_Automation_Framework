...
**Spec**: `tests/local-office/local-office-history.spec.ts`
...
Authoritative current case list (7 cases). Scenario prose above may lag; this index is mechanically regenerated.
