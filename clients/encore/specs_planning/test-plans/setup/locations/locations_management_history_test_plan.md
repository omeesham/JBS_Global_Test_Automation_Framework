# Location Management History Test Plan — **Module**: locations | **Test Cases**: [test-cases/setup/locations/locations_management_history_test_cases.md](../../test-cases/setup/locations/locations_management_history_test_cases.md)
...
Authoritative current case list (25 cases). Scenario prose above may lag; this index is mechanically regenerated.
