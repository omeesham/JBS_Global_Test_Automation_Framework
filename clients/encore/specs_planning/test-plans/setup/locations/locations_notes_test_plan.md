...
**Test Cases**: specs_planning/test-cases/setup/locations/locations_notes_test_cases.md
...
Authoritative current case list (58 cases). Scenario prose above may lag; this index is mechanically regenerated.
