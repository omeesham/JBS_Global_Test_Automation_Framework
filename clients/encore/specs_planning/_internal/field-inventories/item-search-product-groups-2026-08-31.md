...
| `struct:th\|Name\|div/div/div/table/thead/tr` | th | 2026-08-31 | out-of-scope: static header cell — interactive behavior lives on the header menu button row |
...
| `struct:th\|Service Type\|div/div/div/table/thead/tr` | th | 2026-08-31 | out-of-scope: static header cell — interactive behavior lives on the header menu button row |
...
| `struct:th\|Status\|div/div/div/table/thead/tr` | th | 2026-08-31 | out-of-scope: static header cell — interactive behavior lives on the header menu button row |
