...
| OR-4 | "for barcode verification I will provide few barcode numbers; it should filter those products" | **CLOSED 2026-09-01** — owner supplied 12 barcodes (office 1121 assets, all resolving on the 1101 Products page). All 12 verified live: each returns exactly one product; 5 distinct products across the set. Consumed by TC-ISR-PRS-022…030 (`SUBPLAN_ITEM_SEARCH_BARCODE_COVERAGE.md`). NM-1494's 42-char ceiling confirmed enforced; its charset is NOT policed on entry. |
