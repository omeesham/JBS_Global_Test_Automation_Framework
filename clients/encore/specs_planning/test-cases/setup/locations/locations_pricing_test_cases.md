...
> **CORRECTION (2026-02-18 live verification)**: These are editable comboboxes, NOT read-only display fields. Selections can be made when Corporate Pricing is checked.
...
**Master Toggle Behavior** (✅ CONFIRMED LIVE BEHAVIOR — 2026-02-18):
...
- Prior REQUIREMENTS.md was incorrect; live DOM verified and REQUIREMENTS.md updated
...
**Notes**: CONFIRMED BEHAVIOR (live verified 2026-02-18): Corporate Pricing unchecked -- Primary pricing dropdowns become disabled ONLY; secondary grid (Is Alternative, Use Effective Date, Start Date, End Date) remains fully editable. Prior REQUIREMENTS.md was incorrect; documentation has been updated to reflect actual live behavior.
**Automatable**: Yes
...
**Notes**: Confirmed from Currency tab live verification (office 1604, 2026-02-19): 3 currencies configured -- 4 filter options: All + USD + MXN + CAD
**Automatable**: Yes
