...
## TC-CPR-DET-009: Double-click a source-list product group does NOT add a grid row
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Functional |
...
## TC-CPR-DET-010: Drag a source-list product group onto the grid does NOT add
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Functional |
...
## TC-CPR-DET-021: New Price of 0 is treated as no override (the field clears and Save stays disabled)
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-022: Negative New Price has its minus sign stripped (positive value accepted)
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-023: New Price of a very large value (9999999.99) is flagged invalid and blocks Save
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-024: New Price with extra decimals (12.3456) rounds/truncates to 2dp after clicking outside the field
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Boundary |
...
## TC-CPR-DET-025: New Price overflow (beyond the maximum allowed number) never reaches a committable state
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-026: New Price non-numeric input is discarded (field clears, Save disabled)
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Negative |
...
## TC-CPR-DET-028: Max Discount of 0 is a valid no-discount value (no net change, so Save stays disabled)
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Boundary |
...
## TC-CPR-DET-029: Negative Max Discount has its minus sign stripped (positive value accepted)
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Negative |
...
## TC-CPR-DET-030: Max Discount over 100 (150) is flagged invalid with a tooltip and blocks Save
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Negative |
...
## TC-CPR-DET-035: Read-only Price cell accepts no input and leaves its value unchanged
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Negative |
...
## TC-CPR-DET-036: An off-screen row is found by its content, not its position
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Functional |
...
## TC-CPR-DET-037: Positive control — create mode double-click and drag add a product group row
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Functional |
...
## TC-CPR-DET-038: An empty Max Discount stays empty after a New Price save (no silent coercion)
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-039: New Price-only edit does not reliably enable Save
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Watch |
...
## TC-CPR-DET-040: New Price edit alone should enable Save per the specified requirement
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Watch |
...
## TC-CPR-DET-041: Clearing a staged New Price leaves the Base Price displayed unchanged
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-042: Cross-row price isolation — saving row A does not change row B's price
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Watch |
...
## TC-CPR-DET-043: A saved Max Discount of 100 should still read 100 after reload
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Watch |
...
## TC-CPR-DET-044: Pagination — the Detail grid is non-paginated (no selector, no nav buttons)
| Priority | Status | Type |
|----------|--------|------|
...
## TC-CPR-DET-048: Pagination — each product group appears once
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Surface |
...
## TC-CPR-DET-049: Sorting — the Detail grid column headers are not sort triggers
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Surface |
...
## TC-CPR-DET-050: Render state — New Price renders currency format and Price column is read-only
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Surface |
...
## TC-CPR-DET-051: Render state — editable cell currency format, empty-override shows base price
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Surface |
...
## TC-CPR-DET-052: Empty-volume — 1-row pricebook renders the Detail grid
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Surface |
...
## TC-CPR-DET-053: Empty-volume — 0/1/N row states, off-screen content anchor, volume integrity
| Priority | Status | Type |
|----------|--------|------|
| Medium | Automated | Surface |
...
## TC-CPR-DET-054: Persistence — a Max Discount edit, saved, survives page reload
| Priority | Status | Type |
|----------|--------|------|
| High | Automated | Surface |
