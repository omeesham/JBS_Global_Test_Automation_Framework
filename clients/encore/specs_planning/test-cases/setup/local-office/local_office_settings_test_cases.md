...
The audit plan defined 8 Validate paths. MCP verification proved only **** (Delivery >= Prep) is wired in the the application implementation. The other cross-validators (Set/Delivery, Return/Strike, Return/Pickup, Pickup/Strike) are described in v1 spec but **not implemented** in the live app.
