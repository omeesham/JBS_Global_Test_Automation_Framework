...
**Why:** Session 2026-04-02 — user corrected with "the plan is to run the fucking spec, find failures, run again, find failures, /rca and fix it". Elaborate planning delays action and the root cause is completely unknown until you see the actual failure. You can't plan a fix for something you haven't observed.
